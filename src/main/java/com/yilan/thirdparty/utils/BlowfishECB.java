package com.yilan.thirdparty.utils;//In ECB mode if the same block is encrypted twice with the same key, the resulting
...
//      System.out.println(hexString(bf.decrypt(bf.encrypt(hex2byte("0756D8E0774761D2")))));  
        ...
        System.out.println(bf.encrypt("58153903"));  
        System.out.println(bf.decrypt("6374BABB9C252235"));  
        System.out.println(bf.decrypt(bf.encrypt("���   |")));  
