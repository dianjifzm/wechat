package com.yilan.distributed.lock.zk;

import com.yilan.distributed.lock.Callback;
import com.yilan.distributed.lock.DistributedLockTemplate;
...
public class ZkDistributedLockTemplate implements DistributedLockTemplate {
    ...
    public Object execute(String lockId, int timeout, Callback callback) {
        ...
        try {
            ...
            if(tryLock(distributedReentrantLock,Long.valueOf(timeout))){
                getLock=true;
